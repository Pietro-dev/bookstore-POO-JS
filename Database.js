module.exports = class Database{
    ...
    // métodos para salvar os posters
    ...
    showStorage()
{
    ...
    console.table(this.#storage.orders.map(order => order.data)) // usando o método get orderItems, pq os atributos de order são privados.
}}